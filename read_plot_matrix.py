...
while not has_quit:
    ...
    print('\ta: read current sensor (ADC counts) \tb: read current sensor (mA) \tc: get encoder counts \te: reset encoder \td: read encoder angle \tr: read the mode \tq: Quit') # '\t' is a tab
